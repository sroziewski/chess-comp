...
import os
import tempfile
from chess_puzzle_rating.models.stacking import XGBoostModel

class TestXGBoostModel:
    """Tests for the XGBoostModel class."""
    
    def test_init(self):
        """Test initializing a XGBoostModel."""
        model = XGBoostModel(name="test_xgboost")
        assert model.name == "test_xgboost"
        assert model.model_params is not None
        assert "objective" in model.model_params
        assert model.model_params["objective"] == "reg:squarederror"
        ...
        model = XGBoostModel(name="test_xgboost", model_params=model_params)
        assert model.name == "test_xgboost"
        assert model.model_params == model_params
    
    def test_fit_predict(self):
        """Test fitting and predicting with a XGBoostModel."""
        model = XGBoostModel(name="test_xgboost")
    ...
    def test_save_load(self, tmp_path):
        ...
        model_path = os.path.join(tmp_path, "test_xgboost.pkl")
        ...
        # Create a new model
        new_model = XGBoostModel(name="test_xgboost")
